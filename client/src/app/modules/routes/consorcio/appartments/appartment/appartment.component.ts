...
export class AppartmentComponent implements OnInit{
    ...
    building$: Observable<Building[]> = this.appartmentService.getBuildings(); 
    ...
    createAppartment(): void{
        ...
        this.appartmentService.createAppartment(appartment).subscribe((data: Appartment) => {
